...
|---------------| -----------------|
|[Project Proposal](./p01-proposal.md) | Describes the relationship between gaming and anxiety and defines the goals of our project.
|[Exploratory Data Analysis](./index.Rmd) | Gives a brief summary of our data and three unique visualizations exploring some of our research questions.
